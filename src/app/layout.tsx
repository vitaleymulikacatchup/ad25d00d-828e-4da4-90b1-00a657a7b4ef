...
export const metadata: Metadata = {
  title: "Luxe Hotels | Luxury Accommodations & World-Class Amenities",
  description: "Experience premium hospitality at Luxe Hotels. Book luxurious rooms, enjoy fine dining, spa services, and exceptional amenities. Perfect for business and leisure travelers.",
  keywords: "luxury hotel, accommodations, fine dining, spa, premium rooms, business travel, hospitality",
  metadataBase: new URL("https://luxehotels.com"),
  alternates: {
    canonical: "https://luxehotels.com"
  },
  openGraph: {
    title: "Luxe Hotels | Premium Hospitality Experience",
    description: "Discover world-class accommodations and exceptional service at Luxe Hotels. Book your perfect stay today.",
    type: "website",
    siteName: "Luxe Hotels",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32m5rRdd38TAyU0DZCqvrl288SF/uploaded-1763917027988-dcpz8bwk.jpg",
        alt: "Luxe Hotels - Luxury Hotel Lobby"
      }
    ]
  },
  twitter: {
    card: "summary_large_image",
    title: "Luxe Hotels | Experience Luxury Hospitality",
    description: "Book your stay at Luxe Hotels and enjoy premium rooms, fine dining, spa services, and unforgettable experiences.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32m5rRdd38TAyU0DZCqvrl288SF/uploaded-1763917027988-dcpz8bwk.jpg"]
  },
  robots: {
    index: true,
    follow: true
